...
const Footer = ({isDesktop}) => {
    return(
        <Center w="100%" h="192px" bgColor="#080818" top={0}>
            {isDesktop ? <Image src="./images/footerLogo.svg" className={styles.footerLogo} height={{base:"48px", sm: "92px", md: "128px"}}/> : <Image src="./images/footerLogo.svg" className={styles.footerLogo2}/>}
            {isDesktop ? <Stack alignItems="center" >
                ...
                <Text fontSize="md" color="white" className={styles.footerFont} fontSize={{base:"14px", md: "16px"}}>
                        Copyright @2021 StudentsxCEOs 
                </Text>
            </Stack>}
        </Center>
